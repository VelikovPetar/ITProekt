                ...
                <div class="col-xs-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-xs-6">
                                    <asp:Label ID="pi" runat="server" Text="Лични информации:"></asp:Label><asp:Label ID="lblPersonalInfo" runat="server" ForeColor="#CC0000"></asp:Label><br />
                                    <br />
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <asp:Label runat="server" class="pi" Text="Минати прегледи:"></asp:Label><asp:Label ID="lblPastAppointmentsInfo" runat="server" ForeColor="#CC0000"></asp:Label><br />
                                    <br />
                                ...
                                <div class="col-xs-6">
                                    <asp:Label class="pi" runat="server" Text="Идни прегледи:"></asp:Label><asp:Label ID="lblUpcomingAppointmentsInfo" runat="server" ForeColor="#CC0000"></asp:Label><br />
                                    <br />
