...
<body>
    ...
    <div id="tabb" class="container">	
		<ul  class="nav nav-pills">
			<li class="active bt">
        		<a  href="#tab1" data-toggle="tab"><asp:Button ID="tabPersonalInfo" class="btn btn-primary tabovi" runat="server"  Text="Лични информации" /></a>
			</li>
			<li class="bt">
                <a href="#tab2" data-toggle="tab"> <asp:Button ID="tabGpPatients" class="btn btn-primary tabovi" runat="server" Text="Пациенти" /></a>
			</li>
			<li class="bt">
                <a href="#tab3" data-toggle="tab"><asp:Button ID="tabFreePatients" class="btn btn-primary tabovi" runat="server"  Text="Слободни пациенти" /></a>
			</li>
			<li class="bt">
                <a href="#tab4" data-toggle="tab"><asp:Button ID="tabAllAppointments" class="btn btn-primary tabovi" runat="server" Text="Прегледи" /></a>
			</li>
		</ul>
