...
<body>
    <form id="form1" runat="server">
            ...
            <ul class="nav nav-pills">
                <li class="active bt">
                    <a href="#tab1" data-toggle="tab">
                        <asp:Button ID="tabPersonalInfo" runat="server" class="tabovi" Text="Лични информации" /></a>
                </li>
                <li class="bt">
                    <a href="#tab2" data-toggle="tab">
                        <asp:Button ID="tabPastAppointments" runat="server" class="tabovi" Text="Минати прегледи" /></a>
                </li>
                <li class="bt">
                    <a href="#tab3" data-toggle="tab">
                        <asp:Button ID="tabUpcomingAppointments" runat="server" class="tabovi" Text="Идни прегледи" /></a>
                </li>
                <li class="bt">
                    <a href="#tab4" data-toggle="tab">
                        <asp:Button ID="tabAllPatients" runat="server" class="tabovi" Text="Пациенти" /></a>
                </li>
            </ul>
        ...
        <asp:Button ID="btnLogout" CssClass="btn btn-primary btn-danger but1 odj" runat="server" Text="Одјавете се" OnClick="btnLogout_Click" />
