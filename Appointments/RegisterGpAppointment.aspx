                        ...
                        <form class=" form-horizontal" runat="server" id="form1">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtTime" ErrorMessage="You must enter time in format HH:mm! " ValidationExpression="^([0-9]|0[0-9]|1[0-9]|[0-3]):[0-5][0-9]$" Display="None"></asp:RegularExpressionValidator>
                                </div>
                            </div>
                            ...
                            <div class=" col-xs-6  ">
                                <asp:Button class="btn btn-info btn-block btn-lg" runat="server" Font-Size="16" Text="Дома" ID="btnHome" CausesValidation="false" OnClick="btnHome_Click" />
                            </div>
