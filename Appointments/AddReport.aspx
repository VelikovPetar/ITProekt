                        ...
                        <form class=" form-horizontal" runat="server">
                            ...
                            <div class="det">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <asp:TextBox ID="txtDiagnosis" ValidationGroup="reportGroup" runat="server" Rows="4" Height="100px" TextMode="MultiLine" CssClass="TextBox" Width="90%"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="reportGroup" runat="server" ControlToValidate="txtDiagnosis" Display="None" ErrorMessage="Diagnosis field cannot be empty!"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <asp:TextBox ID="txtTherapy" ValidationGroup="reportGroup" runat="server" Rows="4" Height="100px" TextMode="MultiLine" CssClass="TextBox" Width="90%"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="reportGroup" runat="server" ControlToValidate="txtTherapy" Display="None" ErrorMessage="Therapy field cannot be empty!"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <asp:TextBox ID="txtRemark" runat="server" Rows="6" Height="130px" TextMode="MultiLine" CssClass="TextBox" Width="90%" ValidationGroup="reportGroup"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class=" col-xs-6  ">
                                <asp:Button ID="btnAddReport" runat="server" class="btn btn-success  btn-block btn-lg" Font-Size="16" OnClick="btnAddReport_Click" Text="Внеси извештај" ValidationGroup="reportGroup" />
                            </div>
                            <div class=" col-xs-6  ">
                                <asp:Button ID="btnHome" runat="server" class="btn btn-info  btn-block btn-lg" Font-Size="16" OnClick="btnHome_Click" Text="Дома" CausesValidation="false"/>
                            </div>
                        </form>
                    </div>
                </div>
